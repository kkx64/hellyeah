...
public class GrapplingWeapon : CoreWeapon
{
    [Header("References")]
    ...
    void Start()
    {
        ...
        orientation = player;
        predictionPoint = Instantiate(predictionPointPrefab, null).transform;
    }
    ...
    private void OdmGearMovement()
    {
        ...
        {
            float extendedDistanceFromPoint =
                Vector3.Distance(transform.position, swingPoint) + extendCableSpeed;
