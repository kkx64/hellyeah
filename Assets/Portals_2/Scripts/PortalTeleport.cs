...
public class PortalTeleport : MonoBehaviour
{
 ...
 //   private SpawnPortal portalSpawner;
    ...
    private void Teleport(Collider teleportObject)
    {
        ...
        Vector3 relativeVel = this.transform.InverseTransformDirection(rb.linearVelocity);
        relativeVel = Quaternion.Euler(0.0f, 180.0f, 0.0f) * relativeVel;
        rb.linearVelocity = otherPortal.transform.TransformDirection(relativeVel);
        ...
        playerCam.SetNewRotation(currentRotation.x, currentRotation.y); 
